...
def main(argument):
    ...
    Ap.add_argument(
        "-l", "--List", action="store_true", help="only listup update lists"
    )
    Ap.add_argument(
        "-d", "--Download", action="store_true", help="only download update packages"
    )
    Ap.add_argument("-u", "--Update", action="store_true", help="only update packages")
    Ap.add_argument(
        "-v", "--version", action="version", version="3.7", help="this script version"
    )
